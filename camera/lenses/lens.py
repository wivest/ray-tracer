...
class Lens(ABC):
    ...
    @ti.kernel
    def _render_sample(self, pixels: ti.template(), triangles: ti.template(), bvhs: ti.template(), lights: ti.template()):  # type: ignore
        ...
        for x, y in pixels:
            ...
            incoming_light = self._get_color(ray, triangles, bvhs, lights)
